...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id BAA4A2401D
	for <lists+linux-input@lfdr.de>; Mon, 20 May 2019 20:15:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727187AbfETSPl (ORCPT <rfc822;lists+linux-input@lfdr.de>);
        Mon, 20 May 2019 14:15:41 -0400
Received: from mx1.redhat.com ([209.132.183.28]:40316 "EHLO mx1.redhat.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726447AbfETSPl (ORCPT <rfc822;linux-input@vger.kernel.org>);
        Mon, 20 May 2019 14:15:41 -0400
Received: from smtp.corp.redhat.com (int-mx04.intmail.prod.int.phx2.redhat.com [10.5.11.14])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mx1.redhat.com (Postfix) with ESMTPS id 4777B59467;
        Mon, 20 May 2019 18:15:40 +0000 (UTC)
Received: from shalem.localdomain.com (ovpn-116-135.ams2.redhat.com [10.36.116.135])
        by smtp.corp.redhat.com (Postfix) with ESMTP id D330B5DD7B;
...
Subject: [PATCH 3/7] HID: lg-g15: Add keyboard and LCD backlight control
Date:   Mon, 20 May 2019 20:15:21 +0200
Message-Id: <20190520181525.4898-4-hdegoede@redhat.com>
In-Reply-To: <20190520181525.4898-1-hdegoede@redhat.com>
References: <20190520181525.4898-1-hdegoede@redhat.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.14
X-Greylist: Sender IP whitelisted, not delayed by milter-greylist-4.5.16 (mx1.redhat.com [10.5.110.39]); Mon, 20 May 2019 18:15:40 +0000 (UTC)
...
---
 drivers/hid/hid-lg-g15.c | 154 +++++++++++++++++++++++++++++++++++++++
 1 file changed, 154 insertions(+)

diff --git a/drivers/hid/hid-lg-g15.c b/drivers/hid/hid-lg-g15.c
index 1e35739a461b..51c92951975c 100644
...
@@ -151,6 +291,7 @@ static int lg_g15_probe(struct hid_device *hdev, const struct hid_device_id *id)
...
+	INIT_WORK(&g15->work, lg_g15_leds_changed_work);
 	...
 	switch (g15->model) {
@@ -196,6 +337,12 @@ static int lg_g15_probe(struct hid_device *hdev, const struct hid_device_id *id)
 		goto error_hw_stop;
 	}
...
@@ -227,6 +374,13 @@ static int lg_g15_probe(struct hid_device *hdev, const struct hid_device_id *id)
 	if (ret)
 		goto error_hw_stop;
