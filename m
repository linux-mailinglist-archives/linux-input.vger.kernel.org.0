...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id CC3B124020
	for <lists+linux-input@lfdr.de>; Mon, 20 May 2019 20:15:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727229AbfETSPp (ORCPT <rfc822;lists+linux-input@lfdr.de>);
        Mon, 20 May 2019 14:15:45 -0400
Received: from mx1.redhat.com ([209.132.183.28]:54058 "EHLO mx1.redhat.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727189AbfETSPp (ORCPT <rfc822;linux-input@vger.kernel.org>);
        Mon, 20 May 2019 14:15:45 -0400
Received: from smtp.corp.redhat.com (int-mx04.intmail.prod.int.phx2.redhat.com [10.5.11.14])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mx1.redhat.com (Postfix) with ESMTPS id 6E12D4E908;
        Mon, 20 May 2019 18:15:44 +0000 (UTC)
Received: from shalem.localdomain.com (ovpn-116-135.ams2.redhat.com [10.36.116.135])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 549FF5DEA9;
...
Subject: [PATCH 6/7] HID: lg-g15: Add support for controlling the G510's RGB backlight
Date:   Mon, 20 May 2019 20:15:24 +0200
Message-Id: <20190520181525.4898-7-hdegoede@redhat.com>
In-Reply-To: <20190520181525.4898-1-hdegoede@redhat.com>
References: <20190520181525.4898-1-hdegoede@redhat.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.14
X-Greylist: Sender IP whitelisted, not delayed by milter-greylist-4.5.16 (mx1.redhat.com [10.5.110.38]); Mon, 20 May 2019 18:15:44 +0000 (UTC)
...
index cbcc0b40535c..0cc3ec0ff974 100644
...
@@ -412,11 +655,11 @@ static int lg_g15_probe(struct hid_device *hdev, const struct hid_device_id *id)
...
@@ -428,12 +671,14 @@ static int lg_g15_probe(struct hid_device *hdev, const struct hid_device_id *id)
 		gkeys = 18;
 		break;
 	case LG_G15_V2:
+		INIT_WORK(&g15->work, lg_g15_leds_changed_work);
...
+		INIT_WORK(&g15->work, lg_g510_leds_sync_work);
 		...
 		gkeys = 18;
@@ -474,7 +719,7 @@ static int lg_g15_probe(struct hid_device *hdev, const struct hid_device_id *id)
 	}
...
@@ -521,9 +766,6 @@ static int lg_g15_probe(struct hid_device *hdev, const struct hid_device_id *id)
 	if (ret)
 		goto error_hw_stop;
