...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0A6C47CD528
	for <lists+linux-input@lfdr.de>; Wed, 18 Oct 2023 09:06:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229933AbjJRHGf (ORCPT <rfc822;lists+linux-input@lfdr.de>);
...
Subject: [PATCH v4 15/17] HID: amd_sfh: rename float_to_int() to amd_sfh_float_to_int()
