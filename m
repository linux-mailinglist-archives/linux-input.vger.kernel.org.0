...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 0A7D0D58F9
	for <lists+linux-input@lfdr.de>; Mon, 14 Oct 2019 02:22:54 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729374AbfJNAWx (ORCPT <rfc822;lists+linux-input@lfdr.de>);
        Sun, 13 Oct 2019 20:22:53 -0400
Received: from mail-io1-f67.google.com ([209.85.166.67]:34939 "EHLO
        mail-io1-f67.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1729296AbfJNAWw (ORCPT
        <rfc822;linux-input@vger.kernel.org>);
        Sun, 13 Oct 2019 20:22:52 -0400
Received: by mail-io1-f67.google.com with SMTP id q10so34381582iop.2
        for <linux-input@vger.kernel.org>; Sun, 13 Oct 2019 17:22:52 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=xh1BZskd4vriXUMHxEfN0e2tdNXy2NLEmr2V0ni0EB4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=xh1BZskd4vriXUMHxEfN0e2tdNXy2NLEmr2V0ni0EB4=;
        b=
X-Gm-Message-State: APjAAAVQJ3BPLEvjX8YF9WVRi1f7awUP7KQd4lRQJqliQ90WL1YY4iDK
        5UazkiIY9rqBjJqDL3GllZF2H/N+Nj0=
X-Google-Smtp-Source: APXvYqw/eLtNSIXikO2LVG7YiE8dkeDLzhr2i/cqNeLgNMevvli71V7Rf5RfQwxpbYTFh0SLSUL9gg==
X-Received: by 2002:a6b:730d:: with SMTP id e13mr11034183ioh.217.1571012571248;
        Sun, 13 Oct 2019 17:22:51 -0700 (PDT)
Received: from Arrakis.djogorchock.com ([136.61.189.171])
        by smtp.gmail.com with ESMTPSA id s201sm22103963ios.83.2019.10.13.17.22.50
...
Subject: [PATCH v8 5/9] HID: nintendo: add rumble support
Date:   Sun, 13 Oct 2019 19:22:37 -0500
Message-Id: <20191014002241.2560195-6-djogorchock@gmail.com>
...
index e9d61e1a7186..ccbcb94616c9 100644
...
+
 	...
 	if (ret)
 		return ret;
@@ -955,21 +1281,26 @@ static int nintendo_hid_probe(struct hid_device *hdev,
...
@@ -1022,6 +1353,13 @@ static int nintendo_hid_probe(struct hid_device *hdev,
 		goto err_mutex;
 	}
...
@@ -1055,6 +1393,8 @@ static int nintendo_hid_probe(struct hid_device *hdev,
 	hid_hw_close(hdev);
 err_stop:
 	hid_hw_stop(hdev);
+err_wq:
+	destroy_workqueue(ctlr->rumble_queue);
 err:
 	...
 	return ret;
@@ -1065,6 +1405,7 @@ static void nintendo_hid_remove(struct hid_device *hdev)
