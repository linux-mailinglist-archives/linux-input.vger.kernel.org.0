Return-Path: <linux-input+bounces-16883-lists+linux-input=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-input@lfdr.de
Delivered-To: lists+linux-input@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id EFF34D0708D
	for <lists+linux-input@lfdr.de>; Fri, 09 Jan 2026 04:49:45 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id D42DF304C67E
	for <lists+linux-input@lfdr.de>; Fri,  9 Jan 2026 03:46:51 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 6F50D78F3E;
	Fri,  9 Jan 2026 03:46:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=endrift.com header.i=@endrift.com header.b="GVfW94MT"
X-Original-To: linux-input@vger.kernel.org
Received: from endrift.com (endrift.com [173.255.198.10])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E6E5F24A058
	for <linux-input@vger.kernel.org>; Fri,  9 Jan 2026 03:46:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=173.255.198.10
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1767930410; cv=none; b=lXJqL3MqC/t/zakGe+bo1cDeSl6+Afmldz9Ualk4g73pLpPMA2Prn0oK5DIMqSldBXHh4OaexlgbZF/NQLP5mVRqJzdz3PmKRn9E1arDGTGXnDJCQILpMlQNdOlnQ4Nj0g/mC+ZTXxhExMb3rT6NB3Um3Kz7deQ7OGi2u+qJXa8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1767930410; c=relaxed/simple;
	bh=t7JeZpISrglrpk5NNtNGPeEwK/fFN2FN4jSA08DOzzc=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=VSSlS0ho9PhLqfNGWefxyRdATCzvROT11zRdDOpGYg9dOVflNVu9CbirWvacwNKBoYb4i0V6wG4B9/67smtK0CbANhvBwvSk9SzlWRZNI5ehcpCFWhfJeoErsGo4czFrmqrrvoUVkbcf4fJlnUVXCX60kj5aL6Bo+PxojfJKApM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=endrift.com; spf=pass smtp.mailfrom=endrift.com; dkim=pass (2048-bit key) header.d=endrift.com header.i=@endrift.com header.b=GVfW94MT; arc=none smtp.client-ip=173.255.198.10
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=endrift.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=endrift.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=endrift.com; s=2020;
	t=1767930046; bh=t7JeZpISrglrpk5NNtNGPeEwK/fFN2FN4jSA08DOzzc=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
	b=
Received: from nebulosa.vulpes.eutheria.net (71-212-14-89.tukw.qwest.net [71.212.14.89])
	by endrift.com (Postfix) with ESMTPSA id 19BC3A070;
	Thu,  8 Jan 2026 19:40:46 -0800 (PST)
...
Subject: [PATCH v2 1/1] HID: switch2: Add preliminary Switch 2 controller driver
Date: Thu,  8 Jan 2026 19:40:32 -0800
Message-ID: <20260109034034.565630-2-vi@endrift.com>
X-Mailer: git-send-email 2.51.2
In-Reply-To: <20260109034034.565630-1-vi@endrift.com>
References: <20260109034034.565630-1-vi@endrift.com>
Precedence: bulk
...
index a0dd762f5648..932e73d80bbb 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -18541,6 +18541,13 @@ L:	linux-input@vger.kernel.org
 S:	Maintained
...
index 920a64b66b25..32190cf830c4 100644
--- a/drivers/hid/Kconfig
+++ b/drivers/hid/Kconfig
@@ -1142,6 +1142,24 @@ config HID_SUNPLUS
 	help
...
index 361a7daedeb8..74a3f82ed82f 100644
...
index 9c2bf584d9f6..595f94543d85 100644
...
index 000000000000..aa1b46501a1a
--- /dev/null
...
new file mode 100644
index 000000000000..561b16bbe3be
--- /dev/null
...
index 7755e5b454d2..73b0e15205ae 100644
...
index 9976f596a920..46feb7ef60ba 100644
...
new file mode 100644
index 000000000000..c16047f068ee
--- /dev/null
