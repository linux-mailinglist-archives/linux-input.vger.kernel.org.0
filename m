...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 194112401F
	for <lists+linux-input@lfdr.de>; Mon, 20 May 2019 20:15:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726447AbfETSPn (ORCPT <rfc822;lists+linux-input@lfdr.de>);
        Mon, 20 May 2019 14:15:43 -0400
Received: from mx1.redhat.com ([209.132.183.28]:60270 "EHLO mx1.redhat.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727229AbfETSPn (ORCPT <rfc822;linux-input@vger.kernel.org>);
        Mon, 20 May 2019 14:15:43 -0400
Received: from smtp.corp.redhat.com (int-mx04.intmail.prod.int.phx2.redhat.com [10.5.11.14])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mx1.redhat.com (Postfix) with ESMTPS id 11F5F3098558;
        Mon, 20 May 2019 18:15:43 +0000 (UTC)
Received: from shalem.localdomain.com (ovpn-116-135.ams2.redhat.com [10.36.116.135])
        by smtp.corp.redhat.com (Postfix) with ESMTP id E832A5DD7B;
        Mon, 20 May 2019 18:15:41 +0000 (UTC)
From:   Hans de Goede <hdegoede@redhat.com>
To:     Dmitry Torokhov <dmitry.torokhov@gmail.com>,
        Jiri Kosina <jikos@kernel.org>,
        Benjamin Tissoires <benjamin.tissoires@redhat.com>
Cc:     Hans de Goede <hdegoede@redhat.com>, linux-input@vger.kernel.org
Subject: [PATCH 5/7] HID: lg-g15: Add support for the G510 keyboards' gaming keys
Date:   Mon, 20 May 2019 20:15:23 +0200
Message-Id: <20190520181525.4898-6-hdegoede@redhat.com>
In-Reply-To: <20190520181525.4898-1-hdegoede@redhat.com>
References: <20190520181525.4898-1-hdegoede@redhat.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.14
X-Greylist: Sender IP whitelisted, not delayed by milter-greylist-4.5.16 (mx1.redhat.com [10.5.110.49]); Mon, 20 May 2019 18:15:43 +0000 (UTC)
...
index a6e8c2fdb7b2..4baeab3f4a48 100644
...
index 3d0909e8f211..cbcc0b40535c 100644
...
+
 	...
 	if (!g15)
 		return -ENOMEM;
@@ -351,6 +432,12 @@ static int lg_g15_probe(struct hid_device *hdev, const struct hid_device_id *id)
...
@@ -372,6 +459,15 @@ static int lg_g15_probe(struct hid_device *hdev, const struct hid_device_id *id)
 		hid_hw_close(hdev);
 	}
...
+
 	if (ret < 0) {
 		...
 		goto error_hw_stop;
@@ -407,6 +503,17 @@ static int lg_g15_probe(struct hid_device *hdev, const struct hid_device_id *id)
 	for (i = 0; i < 5; i++)
...
@@ -414,6 +521,9 @@ static int lg_g15_probe(struct hid_device *hdev, const struct hid_device_id *id)
 	if (ret)
 		goto error_hw_stop;
...
@@ -435,6 +545,14 @@ static const struct hid_device_id lg_g15_devices[] = {
