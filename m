...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 202B5D072E
	for <lists+linux-input@lfdr.de>; Wed,  9 Oct 2019 08:29:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729491AbfJIG3H (ORCPT <rfc822;lists+linux-input@lfdr.de>);
        Wed, 9 Oct 2019 02:29:07 -0400
Received: from mail-io1-f66.google.com ([209.85.166.66]:41880 "EHLO
        mail-io1-f66.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1729352AbfJIG3H (ORCPT
        <rfc822;linux-input@vger.kernel.org>); Wed, 9 Oct 2019 02:29:07 -0400
Received: by mail-io1-f66.google.com with SMTP id n26so2463776ioj.8
        for <linux-input@vger.kernel.org>; Tue, 08 Oct 2019 23:29:06 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=g6KB2RIp2hg6OFNNFXj0tFcp7gtcKQkiu+6bFrGTlwQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=g6KB2RIp2hg6OFNNFXj0tFcp7gtcKQkiu+6bFrGTlwQ=;
        b=
X-Gm-Message-State: APjAAAUO1BXTTjMh5GTglkBttP4+1ZhPkOKAa45pyo2SP7lAj1Z5L0HV
        1y4WqJhl41lDIpRqT9IZCdrU0oWpIrQ=
X-Google-Smtp-Source: APXvYqxpGNAi5bzOpcJ2YFiaxX9XhHtUz51wn0l/cidzi4kSfKAgqLGAhg7NismXUN2BDmbnE9p/CA==
X-Received: by 2002:a6b:db07:: with SMTP id t7mr1966989ioc.115.1570602545415;
        Tue, 08 Oct 2019 23:29:05 -0700 (PDT)
Received: from Arrakis.djogorchock.com ([136.61.189.171])
        by smtp.gmail.com with ESMTPSA id r22sm880844ilb.85.2019.10.08.23.29.04
...
Subject: [PATCH v7 5/8] HID: nintendo: add rumble support
Date:   Wed,  9 Oct 2019 01:28:30 -0500
Message-Id: <20191009062833.3599398-6-djogorchock@gmail.com>
...
---
 ...
 drivers/hid/hid-nintendo.c | 337 ++++++++++++++++++++++++++++++++++++-
...
index 9108d85f7668..ada6374ba217 100644
...
@@ -448,10 +600,15 @@ static void joycon_parse_report(struct joycon_ctlr *ctlr,
 	u8 tmp;
 	u32 btns;
...
-	spin_lock_irqsave(&ctlr->lock, flags);
 	...
 	tmp = tmp >> 5;
@@ -552,6 +709,161 @@ static void joycon_parse_report(struct joycon_ctlr *ctlr,
 	input_sync(dev);
 }
...
@@ -616,6 +928,19 @@ static int joycon_input_create(struct joycon_ctlr *ctlr)
...
+
 	...
 	if (ret)
 		return ret;
@@ -956,10 +1281,13 @@ static int nintendo_hid_probe(struct hid_device *hdev,
...
+	INIT_WORK(&ctlr->rumble_worker, joycon_rumble_worker);
 	...
 	ret = hid_parse(hdev);
 	if (ret) {
@@ -1016,6 +1344,13 @@ static int nintendo_hid_probe(struct hid_device *hdev,
 		goto err_mutex;
 	}
