...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9F31A38B99D
	for <lists+linux-input@lfdr.de>; Fri, 21 May 2021 00:47:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231862AbhETWsy (ORCPT <rfc822;lists+linux-input@lfdr.de>);
        Thu, 20 May 2021 18:48:54 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55754 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230239AbhETWsx (ORCPT
        <rfc822;linux-input@vger.kernel.org>);
        Thu, 20 May 2021 18:48:53 -0400
Received: from mail-qk1-x732.google.com (mail-qk1-x732.google.com [IPv6:2607:f8b0:4864:20::732])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 96B38C061761
        for <linux-input@vger.kernel.org>; Thu, 20 May 2021 15:47:30 -0700 (PDT)
Received: by mail-qk1-x732.google.com with SMTP id x8so17975277qkl.2
        for <linux-input@vger.kernel.org>; Thu, 20 May 2021 15:47:30 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=9E7tAeQ+x35a/xuYJQMCYhrNCANna5B0oucTBRTWMgM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=9E7tAeQ+x35a/xuYJQMCYhrNCANna5B0oucTBRTWMgM=;
        b=
X-Gm-Message-State: AOAM531uoKiEtK8wVPHUG5n/X2WO963W/oGiV7mJkpjwzqglATUF2TY+
        eELLgL+GZWfSzyrY4N7QUtAepjK3p2q3BQ==
X-Google-Smtp-Source: ABdhPJw+PCmqfEs79YcKFs4Vee9WKC2fHAJu2UG/+5aH7sbzg5pzxysIJdVL8tBnEKMAkueuyz2dEQ==
X-Received: by 2002:a05:620a:130f:: with SMTP id o15mr7890580qkj.252.1621550849217;
...
Received: from Arrakis.djogorchock.com (pool-173-68-68-24.nycmny.fios.verizon.net. [173.68.68.24])
        by smtp.gmail.com with ESMTPSA id s11sm2126251qtn.77.2021.05.20.15.47.28
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 20 May 2021 15:47:28 -0700 (PDT)
...
Subject: [PATCH v13 01/15] HID: nintendo: add nintendo switch controller driver
Date:   Thu, 20 May 2021 18:47:01 -0400
Message-Id: <20210520224715.680919-2-djogorchock@gmail.com>
...
index 9450e052f1b13..24248ca0c627d 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -12671,6 +12671,12 @@ W:	http://www.netlab.is.tsukuba.ac.jp/~yokota/izumi/ninja/
...
index 786b71ef7738a..1f23e84f8bdf3 100644
--- a/drivers/hid/Kconfig
+++ b/drivers/hid/Kconfig
@@ -719,6 +719,17 @@ config HID_MULTITOUCH
...
index c4f6d5c613dc4..d12c4bf077944 100644
--- a/drivers/hid/Makefile
+++ b/drivers/hid/Makefile
@@ -77,6 +77,7 @@ obj-$(CONFIG_HID_MAYFLASH)	+= hid-mf.o
...
index ba338973e968d..5f353655a47bf 100644
