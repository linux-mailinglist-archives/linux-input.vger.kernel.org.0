Return-Path: <linux-input+bounces-1110-lists+linux-input=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-input@lfdr.de
Delivered-To: lists+linux-input@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 5E2A8824814
	for <lists+linux-input@lfdr.de>; Thu,  4 Jan 2024 19:22:33 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id E0A8F1F22BD0
	for <lists+linux-input@lfdr.de>; Thu,  4 Jan 2024 18:22:32 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E61FF28E02;
	Thu,  4 Jan 2024 18:22:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=tuxedocomputers.com header.i=@tuxedocomputers.com header.b="Ia8fO9I3"
X-Original-To: linux-input@vger.kernel.org
Received: from mail.tuxedocomputers.com (mail.tuxedocomputers.com [157.90.84.7])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 50D1228DDC;
...
Received: from wse.fritz.box (p5de453e7.dip0.t-ipconnect.de [93.228.83.231])
	...
	by mail.tuxedocomputers.com (Postfix) with ESMTPA id 8FF932FC006E;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=tuxedocomputers.com;
	...
	bh=jiKv1QaIQH2PPb9iNz7mZXUKOhkfB1sgaIw/WMJTEK8=;
	b=Ia8fO9I3UHUsN8+Fg0Sf8NUdFctAsNRzGC3rQOdjUCHmsu9gVaFBEnjTvF13IrWR23spoE
	0IgGt6YRtcgvWA113JJg45okBS3qnMAcC9noy+GoACnQjCW3hTMpTZFJXEl10rQKlWaaUl
	pTizS+LBSaFOyaJctB5f3S+zIeg9sdQ=
...
Subject: [PATCH v3 1/2] i8042: Add forcenorestore quirk to leave controller untouched even on s3
Date: Thu,  4 Jan 2024 19:22:07 +0100
Message-Id: <20240104182208.779486-2-wse@tuxedocomputers.com>
...
state by reinitializing things, however this can confuses the controller
