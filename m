...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 5E1541067E9
	for <lists+linux-input@lfdr.de>; Fri, 22 Nov 2019 09:25:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727571AbfKVIZw (ORCPT <rfc822;lists+linux-input@lfdr.de>);
        Fri, 22 Nov 2019 03:25:52 -0500
Received: from esa4.mentor.iphmx.com ([68.232.137.252]:62576 "EHLO
        esa4.mentor.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727569AbfKVIZw (ORCPT
        <rfc822;linux-input@vger.kernel.org>);
        Fri, 22 Nov 2019 03:25:52 -0500
IronPort-SDR: 
X-IronPort-AV: E=Sophos;i="5.69,229,1571731200"; 
   d="scan'208";a="43457607"
Received: from orw-gwy-02-in.mentorg.com ([192.94.38.167])
  by esa4.mentor.iphmx.com with ESMTP; 22 Nov 2019 00:25:51 -0800
IronPort-SDR: 
...
Subject: [PATCH v6 29/48] Input: atmel_mxt_ts - implement improved debug message interface
Date:   Fri, 22 Nov 2019 17:23:43 +0900
Message-ID: <20191122082402.18173-30-jiada_wang@mentor.com>
...
index 6f4274a1c7e0..db91caff40e4 100644
...
@@ -3874,6 +4062,7 @@ static int mxt_probe(struct i2c_client *client, const struct i2c_device_id *id)
...
@@ -3932,6 +4121,7 @@ static int mxt_remove(struct i2c_client *client)
