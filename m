...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 505B323B193
	for <lists+linux-input@lfdr.de>; Tue,  4 Aug 2020 02:12:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728309AbgHDAL2 (ORCPT <rfc822;lists+linux-input@lfdr.de>);
        Mon, 3 Aug 2020 20:11:28 -0400
Received: from out5-smtp.messagingengine.com ([66.111.4.29]:57507 "EHLO
        out5-smtp.messagingengine.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1728010AbgHDAL2 (ORCPT
        <rfc822;linux-input@vger.kernel.org>);
        Mon, 3 Aug 2020 20:11:28 -0400
Received: from compute7.internal (compute7.nyi.internal [10.202.2.47])
        by mailout.nyi.internal (Postfix) with ESMTP id BAF165C013A;
        Mon,  3 Aug 2020 20:11:24 -0400 (EDT)
Received: from mailfrontend2 ([10.202.2.163])
  by compute7.internal (MEProxy); Mon, 03 Aug 2020 20:11:24 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=
        messagingengine.com; h=cc:content-type:date:from:message-id
        :mime-version:reply-to:subject:to:x-me-proxy:x-me-proxy
        :x-me-sender:x-me-sender:x-sasl-enc; s=fm3; bh=iZRZYB24EyEl/UHLj
        s1mJ45MZ7+0oGIodpsssvUqWEA=; b=Qsy0I4nxYsVcyUAnmQRldV7BwoN0DD0l7
        
X-ME-Sender: <xms:rKcoX36zM39cRW3eYEl43ng2tjocPlrbZSYz8PDb8BG_Pyk02gO4Aw>
X-ME-Proxy-Cause: 
    hnvghsrdguvghv
X-ME-Proxy: <xmx:rKcoX868ZKDHHTrtjBKUXvuM81MPIEXVDttYYTs-BKilZxI9Xf6gcQ>
    <xmx:rKcoX-fPzXXVW_bIPu2u2EpXCpoiLw8zfOenato7zIrQ7VrrVGAxiA>
    <xmx:rKcoX4J7QlFyEmA-tUcPrmswmbYUXZwq3KmXKIBWABjkyF6CZ8yIVw>
    <xmx:rKcoXwXQq0HZjYbLhj40loZVItrJMkJ5e0Q5BrwHJ7aXQQ2PNzCChA>
Received: from [192.168.20.21] (203-114-141-16.sta.inspire.net.nz [203.114.141.16])
        by mail.messagingengine.com (Postfix) with ESMTPA id 2EB3630600B1;
        Mon,  3 Aug 2020 20:11:21 -0400 (EDT)
Date:   Tue, 04 Aug 2020 12:11:08 +1200
From:   Luke Jones <luke@ljones.dev>
Reply-To: luke@ljones.dev
Subject: [PATCH V3]: HID: asus: add support for ASUS N-Key keyboard
To:     linux-input@vger.kernel.org
Cc:     jikos@kernel.org, benjamin.tissoires@redhat.com
Message-Id: <K6JIEQ.8WHC60A0TYJ6@ljones.dev>
