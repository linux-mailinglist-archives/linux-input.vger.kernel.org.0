...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 05B5438B9A2
	for <lists+linux-input@lfdr.de>; Fri, 21 May 2021 00:47:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231861AbhETWs6 (ORCPT <rfc822;lists+linux-input@lfdr.de>);
        Thu, 20 May 2021 18:48:58 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55774 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231871AbhETWs5 (ORCPT
        <rfc822;linux-input@vger.kernel.org>);
        Thu, 20 May 2021 18:48:57 -0400
Received: from mail-qk1-x72f.google.com (mail-qk1-x72f.google.com [IPv6:2607:f8b0:4864:20::72f])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9DDA6C061574
        for <linux-input@vger.kernel.org>; Thu, 20 May 2021 15:47:34 -0700 (PDT)
Received: by mail-qk1-x72f.google.com with SMTP id c20so17973666qkm.3
        for <linux-input@vger.kernel.org>; Thu, 20 May 2021 15:47:34 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=Vz+wioIL/cAWoxb637DkKzgNlvkbEECIFFP7ioB6xeE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=Vz+wioIL/cAWoxb637DkKzgNlvkbEECIFFP7ioB6xeE=;
        b=
X-Gm-Message-State: AOAM531jN19eNOHdBWYshgC9XU21AhyoFJXfFwThWW3sFKjcO4ySCbVU
        9kFi3sgrnEPNTmTjooOQ7ldA/6P9HSDQdg==
X-Google-Smtp-Source: ABdhPJyGERc8xROrPHM/ADDNDmRczkVNoDp/ZKLsuvwdoPks1UC5I4gMwHrqExs/bjViJVhzjXyG4g==
X-Received: by 2002:a05:620a:4515:: with SMTP id t21mr7808457qkp.442.1621550853403;
...
Received: from Arrakis.djogorchock.com (pool-173-68-68-24.nycmny.fios.verizon.net. [173.68.68.24])
        by smtp.gmail.com with ESMTPSA id s11sm2126251qtn.77.2021.05.20.15.47.32
...
Subject: [PATCH v13 05/15] HID: nintendo: add rumble support
Date:   Thu, 20 May 2021 18:47:05 -0400
Message-Id: <20210520224715.680919-6-djogorchock@gmail.com>
...
index 6d680aaa2e30a..6c75817497095 100644
...
index 8e6c7bde91335..7236ec301de9e 100644
...
+
 	...
 	if (ret)
 		return ret;
@@ -1016,21 +1342,26 @@ static int nintendo_hid_probe(struct hid_device *hdev,
...
@@ -1083,6 +1414,13 @@ static int nintendo_hid_probe(struct hid_device *hdev,
 		goto err_mutex;
 	}
...
+
 	...
 	/* Initialize the leds */
@@ -1116,6 +1454,8 @@ static int nintendo_hid_probe(struct hid_device *hdev,
 	hid_hw_close(hdev);
 err_stop:
 	hid_hw_stop(hdev);
+err_wq:
+	destroy_workqueue(ctlr->rumble_queue);
 err:
 	...
 	return ret;
@@ -1123,7 +1463,10 @@ static int nintendo_hid_probe(struct hid_device *hdev,
