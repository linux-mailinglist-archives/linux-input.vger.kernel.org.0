...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 91E52145406
	for <lists+linux-input@lfdr.de>; Wed, 22 Jan 2020 12:47:16 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726191AbgAVLrP (ORCPT <rfc822;lists+linux-input@lfdr.de>);
        Wed, 22 Jan 2020 06:47:15 -0500
Received: from mail-qk1-f194.google.com ([209.85.222.194]:39804 "EHLO
        mail-qk1-f194.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726094AbgAVLrO (ORCPT
        <rfc822;linux-input@vger.kernel.org>);
        Wed, 22 Jan 2020 06:47:14 -0500
Received: by mail-qk1-f194.google.com with SMTP id c16so6051846qko.6;
        Wed, 22 Jan 2020 03:47:13 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc;
        bh=Zs3fD0ZntQHDPk0N0mfX6boB8qFwKYvX3ANMDZ98N5w=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=Zs3fD0ZntQHDPk0N0mfX6boB8qFwKYvX3ANMDZ98N5w=;
        b=
X-Gm-Message-State: APjAAAV93D5Us7g13cCIkInLqL9yIo1sqPkpDPu+gUzzlt217EbeY9Rx
        QK/CajYgUn3Tk3Smw8iyqfnxhWowoTrePSBPAEcJf+BC
X-Google-Smtp-Source: APXvYqxNTlMCWYt1qTCOMzxkVttqZaGJWv7ghky2hmVzUIwoX+e46Kra1wulXKHI7yz4IZqB9M6XT5Z1stuJUbb5560=
X-Received: by 2002:a37:ba04:: with SMTP id k4mr9501034qkf.74.1579693632469;
 Wed, 22 Jan 2020 03:47:12 -0800 (PST)
MIME-Version: 1.0
References: <1579581860-29560-1-git-send-email-gupt21@gmail.com> <CAO-hwJLhYGbvk5b0gMVrq2-ckHeNo4bt9G3jZ_H1EkWK9cY5GA@mail.gmail.com>
In-Reply-To: <CAO-hwJLhYGbvk5b0gMVrq2-ckHeNo4bt9G3jZ_H1EkWK9cY5GA@mail.gmail.com>
From:   rishi gupta <gupt21@gmail.com>
Date:   Wed, 22 Jan 2020 17:17:01 +0530
Message-ID: <CALUj-gu35z56miSH99y--3s2=k+ceuB--EUhcVtSiNmeEa=B5g@mail.gmail.com>
...
Thanks Benjamin for the review. I have made most of the changes for
next patch except module parameter.
Please see inline:

On Wed, Jan 22, 2020 at 4:58 AM Benjamin Tissoires
...
Removed HIDRAW as not needed. USB_HID is needed for transport layer.
MCP2221 uses HID protocol, uses USB for physical data exchange. Raw
reports are exchanged.

Silicon labs cp2112 is different from mcp2221 (uses interrupt end point).
>
> > +       ---help---
...
MCP2221 provides I2C and SMBUS both.
>
...
I will remove this parameter based on your guidance. But consider
these use-cases:
a) In embedded world each I2C bus is shared by slave operating at same
frequency and
this is fully controlled right in the circuit (schematic) itself. But
one of the strong use case
of this driver is "i2c client driver development on host pc". This
saved me around 20 days
as power supply of ARM board was not stable enough.
b) Slave driver/device during board bring-up. It comes handy to use
low frequency.
c) Prototyping new ideas and demo them quickly without recompile of anything.
>
> > +
...
I will put this before hid-mf.o to maintain alphabetical order
...
I am replacing USB with USB HID to be more clear/elaborative
> > + *
...
> remove that line.
I will remove "#include <linux/usb.h>"
>
> > +#include <linux/i2c.h>
> > +#include "hid-ids.h"
> > +
...
Mentioned use-cases above, if you still suggest I will remove. No problem.
>
...
Okay, I will use memset at all places mentioned.
>
> > +
...
Testing shows it is needed. Also example driver from microchip also
use these sleeps.
~1 milli-second is needed.
>
> > +       } while (len > 0);
> > +
> > +       return ret;
