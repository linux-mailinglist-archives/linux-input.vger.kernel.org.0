...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5E696382AC3
	for <lists+linux-input@lfdr.de>; Mon, 17 May 2021 13:18:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236687AbhEQLTp (ORCPT <rfc822;lists+linux-input@lfdr.de>);
        Mon, 17 May 2021 07:19:45 -0400
Received: from puss.venthur.de ([138.201.246.87]:57874 "EHLO puss.venthur.de"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S236528AbhEQLTo (ORCPT <rfc822;linux-input@vger.kernel.org>);
        Mon, 17 May 2021 07:19:44 -0400
X-Greylist: delayed 566 seconds by postgrey-1.27 at vger.kernel.org; Mon, 17 May 2021 07:19:43 EDT
Received: from [10.3.128.124] (h-213.61.119.98.host.de.colt.net [213.61.119.98])
        by puss.venthur.de (Postfix) with ESMTPSA id 198061E0123;
        Mon, 17 May 2021 13:09:00 +0200 (CEST)
...
Message-ID: <155865d7-f964-ac9a-2c02-1eabeac0e443@venthur.de>
Date:   Mon, 17 May 2021 13:08:59 +0200
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:78.0) Gecko/20100101
 Thunderbird/78.10.0
MIME-Version: 1.0
In-Reply-To: <f82dd7a1-a5c6-b651-846c-29f6df9436af@redhat.com>
...
* the keyboard has a physical switch for Mac and Windows, I have set it
   to Windows
please let me know if i should change fnmode and/or test with the Mac 
setting on.
...
Here's the evemu-record output for the first device. I pressed F1, Fn, 
and Fn+F1 as requested, however only the F1 key produced output. Fn did 
nothing and Fn+F1 decreased the display backlight but didn't produce 
output. You also seem to see my CTRL+C to quit:
...
The output for the second device seems to be the opposite: F1 and Fn 
shows nothing, but Fn+F1 shows a result
