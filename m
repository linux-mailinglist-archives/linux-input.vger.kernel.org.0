...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8A88B430741
	for <lists+linux-input@lfdr.de>; Sun, 17 Oct 2021 10:38:47 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S245084AbhJQIkv (ORCPT <rfc822;lists+linux-input@lfdr.de>);
        Sun, 17 Oct 2021 04:40:51 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46038 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234310AbhJQIkv (ORCPT
        <rfc822;linux-input@vger.kernel.org>);
        Sun, 17 Oct 2021 04:40:51 -0400
X-Greylist: delayed 314 seconds by postgrey-1.37 at lindbergh.monkeyblade.net; Sun, 17 Oct 2021 01:38:41 PDT
Received: from mail.valdk.tel (mail.valdk.tel [IPv6:2a02:e00:ffe7:c::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A9D68C061765
        for <linux-input@vger.kernel.org>; Sun, 17 Oct 2021 01:38:41 -0700 (PDT)
Received: from [127.0.0.1] (localhost [127.0.0.1]) by localhost (Mailerdaemon) with ESMTPSA id 0BCDA28C9CB
        for <linux-input@vger.kernel.org>; Sun, 17 Oct 2021 11:33:21 +0300 (MSK)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=valdikss.org.ru;
        s=msrv; t=1634459603; h=from:subject:date:message-id:to:mime-version:
         content-transfer-encoding; bh=F8erL1UIxpTEL1xD+lcHG+kwjYG7Z32EhSh5YnTJgR0=;
        b=
From:   ValdikSS <iam@valdikss.org.ru>
To:     linux-input@vger.kernel.org
Subject: [PATCH 1/2] Add support for ThinkPad TrackPoint Keyboard II
Date:   Sun, 17 Oct 2021 11:32:45 +0300
Message-Id: <20211017083246.977096-1-iam@valdikss.org.ru>
MIME-Version: 1.0
...
in Windows driver. Native mode disables middle mouse button scrolling
emulation and reports middle button and scrolling events with a custom
report ID, which could be better handled in the driver.
...
---
 ...
 drivers/hid/hid-lenovo.c | 165 +++++++++++++++++++++++++++++++++++++--
 2 files changed, 161 insertions(+), 6 deletions(-)

diff --git a/drivers/hid/hid-ids.h b/drivers/hid/hid-ids.h
index 29564b370..d1fe7925f 100644
...
index 93b1f935e..498246cab 100644
...
@@ -568,6 +707,8 @@ static int lenovo_event(struct hid_device *hdev, struct hid_field *field,
 	switch (hdev->product) {
 	case USB_DEVICE_ID_LENOVO_CUSBKBD:
 	case USB_DEVICE_ID_LENOVO_CBTKBD:
+	case USB_DEVICE_ID_LENOVO_TPIIUSBKBD:
...
@@ -960,8 +1101,9 @@ static int lenovo_probe_cptkbd(struct hid_device *hdev)
...
@@ -977,11 +1119,14 @@ static int lenovo_probe_cptkbd(struct hid_device *hdev)
...
@@ -1088,6 +1233,8 @@ static int lenovo_probe(struct hid_device *hdev,
 		break;
 	case USB_DEVICE_ID_LENOVO_CUSBKBD:
 	case USB_DEVICE_ID_LENOVO_CBTKBD:
+	case USB_DEVICE_ID_LENOVO_TPIIUSBKBD:
+	case USB_DEVICE_ID_LENOVO_TPIIBTKBD:
 		...
 		break;
 	case USB_DEVICE_ID_LENOVO_TP10UBKBD:
@@ -1154,6 +1301,8 @@ static void lenovo_remove(struct hid_device *hdev)
 		break;
 	case USB_DEVICE_ID_LENOVO_CUSBKBD:
 	case USB_DEVICE_ID_LENOVO_CBTKBD:
+	case USB_DEVICE_ID_LENOVO_TPIIUSBKBD:
+	case USB_DEVICE_ID_LENOVO_TPIIBTKBD:
 		...
 		break;
 	case USB_DEVICE_ID_LENOVO_TP10UBKBD:
@@ -1172,6 +1321,8 @@ static int lenovo_input_configured(struct hid_device *hdev,
...
@@ -1188,7 +1339,9 @@ static int lenovo_input_configured(struct hid_device *hdev,
